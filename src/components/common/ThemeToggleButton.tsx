...
const ThemeItem = ({
  ...
  return (
    <button
      ...
      className="flex grow items-center px-2 py-1.5 w-full text-left rounded select-none outline-none hover:bg-neutral-100 dark:hover:bg-neutral-800/70 focus:bg-neutral-100 dark:focus:bg-neutral-800/70"
    >
      <span
        data-state={currentTarget}
        className="text-neutral-600 data-[state=true]:text-[#171717] data-[state=true]:font-bold dark:data-[state=true]:text-[#EAFE7C] dark:text-neutral-400 text-sm font-normal flex grow items-center gap-x-2 "
      >
        {children}
      </span>
    </button>
    ...
    <>
      ...
      {isOpen &&
        ...
        createPortal(
          <div
            ref={modalRef}
            className="absolute flex gap-1 flex-col right-5 top-14 w-40 p-2 bg-white dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 shadow-lg rounded-lg z-[1000] "
          >
            <ThemeItem
              theme="light"
