  ...
  return (
    <PostContainer>
      ...
      <Main>
        ...
        <TextBox>
          블로그에 댓글 기능을 추가하고 싶어 Giscus을 알아보고 바로 블로그에 적용을 한 후 잘
          동작하나 확인을 하던 와중 갑자기 404NotFound가 떠버리는 상황이 발생했다.
        </TextBox>
        ...
        <TextBox>
          <ReferenceLink href='https://reactrouter.com/en/main/router-components/hash-router'>
            https://reactrouter.com/en/main/router-components/hash-router
          </ReferenceLink>
        </TextBox>
        <SubTitle>index.html 리다이렉션 - 깃허브</SubTitle>
        <TextBox>
          <ReferenceLink href='https://github.com/sujinleeme/spa-github-pages-ko'>
        ...
        <TextBox>
          ...
          아니였다고 생각이 든다. 내가 이 문제를 어렵다고 생각한 이유는 지금까지 개발하면서 외부적인
          요인으로 문제가 생긴적은 처음이라 해결 방향을 잘 못잡은게 아닌가라는 생각이 든다. 구글링을
          하며 여러 해결방법들을 프로젝트에 적용을 해보기도 하고 발생한 문제를 여러 단계로 나눠
          해결하고자도 해보았지만 가장 중요한건 문제에 대한 타인에게 설명 할 수 있을 정도의 이해와
          관련 API 참조문서를 찾아보고 연역적인 사고를 통해 추론해내는 방법이 중요하다 생각이
          들었다. 나는 앞으로도 많은 문제들을 마주하게 될 것 이고 그때마다 해결방법이 나올 때 까지
          구글링을 반복하는 것 은 비효율적일뿐더러 성장에 있어서도 안 좋은 방향이다. 이 문제의 가장
          큰 성과는 문제를 해결함이 아니라 앞으로 내가 어떤 방법으로 문제를 해결해 나가면 될지를
          배웠다고 생각이 든다.
        </TextBox>
      </Main>
      <GiscusApp />
