...
export default function CodePrettier() {
  ...
  return (
    <PostContainer>
      <PostHeader title='코드 포멧팅 prettier' tagName='Frond-End' date='2023.07.27' />
      <Main>
        ...
        <TextBox>
          ...
          Format On Type : 사용자가 코드를 입력할 때, 자동으로 코드를 정렬 <br />
        </TextBox>
        <TextBox>설정하면 명령어를 실행하지 않아도 자동으로 포맷팅이 된다.</TextBox>
        참고자료 :<br />
        <ReferenceLink href='https://github.com/prettier/prettier-vscode' target='_blank'>
          https://github.com/prettier/prettier-vscode
        </ReferenceLink>
        <br />
        <ReferenceLink href='https://ux.stories.pe.kr/150' target='_blank'>
