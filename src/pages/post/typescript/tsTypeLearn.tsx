  ...
  return (
    <PostContainer>
      ...
      <Main>
        ...
        <TextBox>
          any는 모든 타입에 대해서 혀용한다는 의미를 가지고 있다 하지만 너무 남발하게 되면 TypeScript를 사용하는
          의미를 잃어버리니 조심하도록 하자.
        </TextBox>
        <CodeContainer>
          <pre>
        ...
        <TextBox>
          object는 interface, class의 상위 타입이다. object로 정의하면 any타입처럼 모든 값을 할당 할 수 있다.
          하지만 any와 같이 typeScript를 사용하는 의미가 없어지니 조심하자.
        </TextBox>
        <CodeContainer>
          <pre>
            <code>
