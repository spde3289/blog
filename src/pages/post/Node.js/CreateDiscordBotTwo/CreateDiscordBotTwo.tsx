...
import { result, totalSearch, change, embeds, expCrawling, charSrarch, charImgLink, imgUrl } from "./imgs"
    ...
    <PostContainer>
      ...
      <Main>
        ...
        <TextBox>
          ...
          처음엔 크롤링이 잘못 된 건가 싶어 콘솔을 찍어 확인해 보니 이미지 주소는 유효한걸 확인 
          할 수 있었다. 
        </TextBox>
        <ImgContainer>
          <Img src={charImgLink} />
        ...
        <TextBox>
          지켜야할 이미지 규격이 있나 공식 문서를 확인해 보니 첨부파일 또는 http(s)만을 지원한다는 
        ...
        <TextBox>
          ...
          이 문제를 해결하기 위해 하루종일 찾아봤지만 뭔가 허무한 결과가 나와버렸다... 
        </TextBox>
        <TextBox>
        </TextBox>
        <SubTitle>
