...
import { PostContainer, Main, SubTitle, TextBox, List, ReferenceLink } from "../style";

export default function RESTful() {
  return (
    <PostContainer>
      <PostHeader title='RESTful이란?' tagName='network' date='2023.02.16' />
      <Main>
        <SubTitle>RESTful이란?</SubTitle>
        <TextBox>
        ...
        <List>
          ...
          <li>언더바(_)사용을 지향하는대신 하이픈(-)을 사용하여 URL가독성 높인다.</li>
          <li>URL경로로는 소문자를 사용한다.</li>
          <li>파일 확장자를 URL에 포함하지 않는다.</li>
          <li>슬래시 구분자(/)는 계층 관계를 나타내는데 사용한다.</li>
        </List>
        <br />
        <TextBox>REST API 서버 응답으로는 다음과 같은 구성 요소가 포함되어 있어야 한다.</TextBox>
        <TextBox>
