...
const SeriesNotFound = () => {
  return (
    <div
      className="mx-auto flex w-full max-w-[886px] flex-col items-center
        justify-center gap-5 py-24 text-center"
    >
      <h2 className="typo-24-b text-neutral-900 dark:text-neutral-100">
        시리즈를 찾을 수 없습니다 😢
      </h2>
      <p
        className="typo-16-body-m text-pretty text-neutral-500
      ...
      <Link
        href="/blog"
        className="mt-4 rounded-lg bg-neutral-900 px-5 py-2.5 text-white
