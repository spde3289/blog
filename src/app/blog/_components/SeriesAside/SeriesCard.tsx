...
const SeriesCard = ({ id, title, postCount, lastUpdated }: SeriesCardProps) => {
  return (
    <Link
      ...
      className="group flex h-full flex-col gap-2 rounded-xl border
        border-neutral-200 bg-white p-4 hover:bg-zinc-50 sm:p-5 lg:p-4
        dark:border-neutral-700 dark:bg-neutral-800/40 dark:hover:bg-zinc-900"
    >
      <div className="flex items-center justify-between gap-4">
        <h2
          className="typo-16-b truncate text-neutral-900
            group-hover:text-blue-600 dark:text-neutral-100
            dark:group-hover:text-blue-400"
        >
          {title}
        </h2>
        <ArrowHeadSVG
          className="size-5 shrink-0 -rotate-90 text-neutral-400
