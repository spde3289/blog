...
const ListViewPost = ({ post, searchText }: ListViewPostProps) => {
  return (
    <li>
      <Link
        href={post.href}
        className="group flex flex-row items-center justify-between gap-5 overflow-hidden rounded-xl border border-neutral-200 bg-white p-4 hover:bg-zinc-50 sm:gap-6 sm:p-5 dark:border-neutral-700 dark:bg-neutral-800/40 dark:hover:bg-zinc-900"
      >
        ...
        <div className="hidden shrink-0 sm:block">
          <ArrowHeadSVG className="size-6 -rotate-90 text-neutral-400 transition-transform group-hover:translate-x-1 dark:text-neutral-500" />
        </div>
      </Link>
    </li>
  );
