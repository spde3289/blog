      ...
      >
        ...
        <button
          ...
          className="group flex w-full cursor-pointer items-center
            justify-center border-t border-neutral-200 bg-white py-3
            hover:bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-800/40
            dark:hover:bg-neutral-700/50"
        >
          <ArrowHeadSVG
            className="size-5 shrink-0 rotate-180 text-neutral-400
  ...
  return (
    <li
      ...
      className="group flex cursor-pointer flex-col overflow-hidden rounded-xl
        border border-neutral-200 bg-white hover:bg-zinc-50
        dark:border-neutral-700 dark:bg-neutral-800/40 dark:hover:bg-zinc-900"
    >
      ...
      <div
        className="flex w-full items-center justify-center border-t
          border-neutral-100 py-2 dark:border-neutral-700/50"
      >
        <ArrowHeadSVG
          className="size-5 shrink-0 text-neutral-400 transition-transform
            group-hover:translate-y-1 dark:text-neutral-500"
        />
      </div>
    </li>
  );
