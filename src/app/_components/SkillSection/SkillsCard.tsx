...
const SkillsCard = () => {
  ...
  return (
    <div
      className="rounded-xl border border-neutral-800 bg-[#1E1E1E] px-6 py-7
        md:px-8 md:py-8"
    >
      <h3
        className="border-b border-neutral-800 pb-4 text-2xl font-bold
          text-neutral-100"
      >
        기술스택
      </h3>
      <div className="mt-5 space-y-5">
        {skillEntries.map(([category, items]) => (
          <div
            key={category}
            className="grid items-center gap-3 border-b border-neutral-800 pb-5
              last:border-b-0 last:pb-0 md:grid-cols-[120px_1fr]"
          >
